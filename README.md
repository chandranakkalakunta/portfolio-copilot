...
| [Requirements](docs/requirements/Portfolio-Copilot-Requirements.md) | Detailed PRD — goals, use cases, FRs/NFRs + operational/platform requirements (draft v0.3) |
...
Early product definition. Requirements **draft v0.3** and architecture **draft v0.1** are in review; implementation is not started. ADRs **0001–0012** record the foundational decisions (0012 — agent framework — is *proposed*, pending a hands-on ADK vs LangGraph spike).

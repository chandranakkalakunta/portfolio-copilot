...
│   └── Portfolio-Copilot-Implementation-Phases.md
...
| [Requirements](docs/requirements/Portfolio-Copilot-Requirements.md) | Detailed PRD — goals, use cases, FRs/NFRs + operational/platform requirements (draft v0.3.2) |
...
| [Implementation Phases](docs/implementation/Portfolio-Copilot-Implementation-Phases.md) | Phased, PR-gated build roadmap — foundations → walking skeleton → MVP → beta → hardening (draft v0.1) |

## Status

Early product definition. Requirements **draft v0.3.2**, architecture **draft v0.1**, and implementation phases **draft v0.1** are in review; build not started. ADRs **0001–0012** record the foundational decisions (0012 — agent framework — is *proposed*, pending a hands-on ADK vs LangGraph spike).

...
**Related documents:** Project One-Pager (`docs/product/Portfolio-Copilot-One-Pager.md`); Multi-Agent Engineering Protocol v4.0 (`chandra-prompts/`); Architecture & Design (`docs/architecture/`, to be written); Design notes (`docs/design/`, to be written); ADRs (`docs/adr/`, to be written).

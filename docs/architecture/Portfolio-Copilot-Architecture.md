...
**Related documents:** Requirements (`docs/requirements/Portfolio-Copilot-Requirements.md`, v0.2); One-Pager (`docs/product/Portfolio-Copilot-One-Pager.md`); Multi-Agent Engineering Protocol v4.0 (`chandra-prompts/`). ADRs: `docs/adr/` (0001–0012); further ADRs written per-decision during implementation (protocol §7.1, §7.5).
